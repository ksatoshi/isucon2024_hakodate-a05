...
ALTER TABLE chairs ADD INDEX name(name);
ALTER TABLE chairs ADD INDEX is_active(is_active);
ALTER TABLE chairs ADD INDEX access_token(access_token);
ALTER TABLE chairs ADD INDEX created_at(created_at);
ALTER TABLE chairs ADD INDEX updated_at(updated_at);
...
ALTER TABLE chair_locations ADD INDEX chair_id(chair_id);
ALTER TABLE chair_locations ADD INDEX latitude(latitude);
ALTER TABLE chair_locations ADD INDEX longitude(longitude);
ALTER TABLE chair_locations ADD INDEX created_at(created_at);
...
ALTER TABLE rides ADD INDEX user_id(user_id);
ALTER TABLE rides ADD INDEX chair_id(chair_id);
ALTER TABLE rides ADD INDEX pickup_latitude(pickup_latitude);
ALTER TABLE rides ADD INDEX pickup_longitude(pickup_longitude);
ALTER TABLE rides ADD INDEX destination_latitude(destination_latitude);
ALTER TABLE rides ADD INDEX destination_longitude(destination_longitude);
ALTER TABLE rides ADD INDEX evaluation(evaluation);
ALTER TABLE rides ADD INDEX created_at(created_at);
ALTER TABLE rides ADD INDEX updated_at(updated_at);
...
ALTER TABLE ride_statuses ADD INDEX ride_id(ride_id);
ALTER TABLE ride_statuses ADD INDEX status(status);
ALTER TABLE ride_statuses ADD INDEX created_at(created_at);
ALTER TABLE ride_statuses ADD INDEX app_sent_at(app_sent_at);
ALTER TABLE ride_statuses ADD INDEX chair_sent_at(chair_sent_at);
...
ALTER TABLE owners ADD INDEX created_at(created_at);
ALTER TABLE owners ADD INDEX updated_at(updated_at);
...
ALTER TABLE coupons ADD INDEX discount(discount);
ALTER TABLE coupons ADD INDEX created_at(created_at);
